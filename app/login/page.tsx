  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-6 py-20">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 rounded border border-panelBorder bg-board py-2 text-sm font-medium text-ink transition hover:border-copper"
      >
